...
func TestWechatBotProxyPolicy(t *testing.T) {
	tests := []struct {
		...
		{http.MethodPost, "/groups/manage/123@chatroom/member-profiles/sync", []string{"wechat-groups", "wechat-wxbot-control"}, true},
		{http.MethodGet, "/groups/manage/123@chatroom/member-profiles/sync", []string{"wechat-groups", "wechat-wxbot-control"}, true},
		{http.MethodPost, "/groups/manage/123@chatroom/members/wxid_a/profile/refresh", []string{"wechat-groups", "wechat-wxbot-control"}, true},
		{http.MethodPost, "/groups/manage/123@chatroom/whitelist", nil, false},
