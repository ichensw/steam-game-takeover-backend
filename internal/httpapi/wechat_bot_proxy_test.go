...
func TestWechatBotProxyPolicy(t *testing.T) {
	tests := []struct {
		...
		{http.MethodGet, "/ai/observation", []string{"wechat-ai-memory"}, true},
		{http.MethodGet, "/ai/config", []string{"wechat-ai-memory"}, true},
		{http.MethodPut, "/ai/config", []string{"wechat-ai-memory"}, true},
		{http.MethodGet, "/ai/memory/facts", []string{"wechat-ai-memory"}, true},
		{http.MethodGet, "/ai/memory/relationships", []string{"wechat-ai-memory"}, true},
		{http.MethodGet, "/ai/memory/events", []string{"wechat-ai-memory"}, true},
		{http.MethodGet, "/ai/interventions", []string{"wechat-ai-memory"}, true},
		{http.MethodGet, "/ai/memory/feedbacks", []string{"wechat-ai-memory"}, true},
		...
		{http.MethodGet, "/ai/memory/persona-candidates/12/evidence", []string{"wechat-ai-memory"}, true},
		{http.MethodPost, "/ai/memory/persona-candidates/12/promote", []string{"wechat-ai-memory"}, true},
		{http.MethodGet, "/ai/memory/persona-versions", []string{"wechat-ai-memory"}, true},
		{http.MethodPost, "/ai/memory/persona-versions/12/rollback", []string{"wechat-ai-memory"}, true},
