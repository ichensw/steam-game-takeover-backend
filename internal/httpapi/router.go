...
func NewRouter(h *Handler) *gin.Engine {
	...
	api.GET("/point-rankings", h.UserAuth(), h.GetPointRankings)
	...
	api.GET("/me/point-logs", h.UserAuth(), h.ListMyPointLogs)
	...
	adminAuthed.GET("/users/:userId/point-logs", h.AdminListUserPointLogs)
	adminAuthed.POST("/users/:userId/points/adjust", h.AdminAdjustUserPoints)
