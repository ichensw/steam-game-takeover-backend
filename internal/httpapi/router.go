...
func NewRouter(h *Handler) *gin.Engine {
	...
	adminAuthed.GET("/kook-channels", h.AdminListKookChannels)
	adminAuthed.POST("/kook-channels", h.AdminCreateKookChannel)
	adminAuthed.GET("/kook-channels/:channelId", h.AdminGetKookChannel)
	adminAuthed.PUT("/kook-channels/:channelId", h.AdminUpdateKookChannel)
	adminAuthed.DELETE("/kook-channels/:channelId", h.AdminDeleteKookChannel)
	adminAuthed.GET("/kook-channels/:channelId/users", h.AdminListKookChannelUsers)
	adminAuthed.POST("/kook-channels/:channelId/move-user", h.AdminMoveKookChannelUsers)
	adminAuthed.POST("/kook-channels/:channelId/kickout", h.AdminKickoutKookChannelUser)
	adminAuthed.GET("/kook-channels/:channelId/roles", h.AdminGetKookChannelRoles)
	adminAuthed.POST("/kook-channels/:channelId/roles", h.AdminCreateKookChannelRole)
